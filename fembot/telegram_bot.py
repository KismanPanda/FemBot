...
DEU_chosen_service_rus = InlineKeyboardMarkup(row_width=2).add(
    ...
    InlineKeyboardButton(text="Медицина", callback_data="DEU_med_main_rus"),
    InlineKeyboardButton(text="Работа", callback_data="DEU_wrk_main_rus"),
...
DEU_chosen_service_ukr = InlineKeyboardMarkup(row_width=2).add(
    ...
    InlineKeyboardButton(text="Медицина", callback_data="DEU_med_main_ukr"),
    InlineKeyboardButton(text="Робота", callback_data="DEU_wrk_main_ukr"),
...
# - Язык русский -
# Клавиатура:
DEU_med_main_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_main_rus_buttons = DEU_med_main_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Прививка/бустер от COVID-19"),
                         callback_data="DEU_med_vacine_covid_rus"),
    InlineKeyboardButton(text=(
        "Плановый осмотр у врача"),
                         callback_data="DEU_med_sceduled_rus"),
    InlineKeyboardButton(text=(
        "Удаленная консультация врача"),
                         callback_data="DEU_med_remote_doctor_rus"),
    InlineKeyboardButton(text=(
        "Получить помощь анонимно, без документов"),
                         callback_data="DEU_med_anonymous_rus"),
    InlineKeyboardButton(text=(
        "Беременность"),
                         callback_data="DEU_med_pregnancy_question_rus"),
    InlineKeyboardButton(text=(
        "Какие лекарства оплатит страховка"),
                         callback_data="DEU_med_insuarance_medicines_rus"),
    InlineKeyboardButton(text=(
        "Проблемы с кассой больничного страхования"),
                         callback_data="DEU_med_insuarance_issues_rus"),
    InlineKeyboardButton(text=(
        "Помощь детям в спектре аутизма"),
                         callback_data="DEU_med_autism_rus"),
    )
DEU_med_main_rus_buttons = DEU_med_main_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_main_rus")
async def DEU_med_main_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_main_rus_buttons,
        parse_mode="html",
        text="Выберите интересующую информацию:"
    )


# - Язык украинский -
# Клавиатура:
DEU_med_main_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_main_ukr_buttons = DEU_med_main_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Щеплення/бустер від COVID-19"),
                         callback_data="DEU_med_vacine_covid_ukr"),
    InlineKeyboardButton(text=(
        "Плановий огляд у лікаря"),
                         callback_data="DEU_med_sceduled_ukr"),
    InlineKeyboardButton(text=(
        "Віддалена консультація лікаря"),
                         callback_data="DEU_med_remote_doctor_ukr"),
    InlineKeyboardButton(text=(
        "Отримати допомогу анонімно, без документів"),
                         callback_data="DEU_med_anonymous_ukr"),
    InlineKeyboardButton(text=(
        "Вагітність"),
                         callback_data="DEU_med_pregnancy_question_ukr"),
    InlineKeyboardButton(text=(
        "Які ліки сплатить страховка"),
                         callback_data="DEU_med_insuarance_medicines_ukr"),
    InlineKeyboardButton(text=(
        "Проблеми з касою лікарняного страхування"),
                         callback_data="DEU_med_insuarance_issues_ukr"),
    InlineKeyboardButton(text=(
        "Допомога дітям у спектрі аутизму"),
                         callback_data="DEU_med_autism_ukr"),
    )
DEU_med_main_ukr_buttons = DEU_med_main_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_main_ukr")
async def DEU_med_main_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_main_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
...
# --- Кнопка МЕДИЦИНА : "Прививка/бустер от COVID-19" ---
# - Язык русский -
# Клавиатура:
DEU_med_vacine_covid_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_vacine_covid_rus_buttons = DEU_med_vacine_covid_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_vacine_covid_rus")
async def DEU_med_vacine_covid_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_vacine_covid_rus_buttons,
        parse_mode="html",
        text=("Коронавирус: информация для беженцев и соискателей "
              "убежища:\nhttps://handbookgermany.de/ru/live/corona"
              "virus/coronavirus-refugees.html\n\nКоронавирус: вак"
              "цинация:\nhttps://handbookgermany.de/ru/live/corona"
              "virus/coronavirus-vaccination.html")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_vacine_covid_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_vacine_covid_ukr_buttons = DEU_med_vacine_covid_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_vacine_covid_ukr")
async def DEU_med_vacine_covid_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_vacine_covid_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nКоронавирус: информация для беженцев и соиск"
              "ателей убежища:\nhttps://handbookgermany.de/ru/live"
              "/coronavirus/coronavirus-refugees.html\n\nКоронавир"
              "ус: вакцинация:\nhttps://handbookgermany.de/ru/live"
              "/coronavirus/coronavirus-vaccination.html")
    )


# --- Кнопка МЕДИЦИНА : "Плановый осмотр у врача" ---
# - Язык русский -
# Клавиатура:
DEU_med_sceduled_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_sceduled_rus_buttons = DEU_med_sceduled_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Да, есть разрешение на пребывание"),
                         callback_data="DEU_med_yes_permit_rus"),
    InlineKeyboardButton(text=(
        "Нет"),
                         callback_data="DEU_med_no_permit_rus"),
    )
DEU_med_sceduled_rus_buttons = DEU_med_sceduled_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_sceduled_rus")
async def DEU_med_sceduled_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_sceduled_rus_buttons,
        parse_mode="html",
        text=("Общую информацию о порядке получения врачебной помо"
              "щи Вы можете получить на сайтах:\nhttps://handbookg"
              "ermany.de/de/ukraine-info/ru/medizinische-versorgun"
              "g.html\nhttp://gesundheit-gefluechtete.info/categor"
              "y/fuer-die-oeffentlichkeit/\n\nВы уже получили разр"
              "ешение на пребывание?")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_sceduled_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_sceduled_ukr_buttons = DEU_med_sceduled_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Так, є дозвіл на перебування"),
                         callback_data="DEU_med_yes_permit_ukr"),
    InlineKeyboardButton(text=(
        "Ні"),
                         callback_data="DEU_med_no_permit_ukr"),
    )
DEU_med_sceduled_ukr_buttons = DEU_med_sceduled_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_sceduled_ukr")
async def DEU_med_sceduled_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_sceduled_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nОбщую информацию о порядке получения врачебн"
              "ой помощи Вы можете получить на сайтах:\nhttps://ha"
              "ndbookgermany.de/de/ukraine-info/ru/medizinische-ve"
              "rsorgung.html\nhttp://gesundheit-gefluechtete.info/"
              "category/fuer-die-oeffentlichkeit/\n\nВы уже получи"
              "ли разрешение на пребывание?")
    )


# --- Кнопка МЕДИЦИНА : "Да, есть разрешение на пребывание" ---
# - Язык русский -
# Клавиатура:
DEU_med_yes_permit_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_yes_permit_rus_buttons = DEU_med_yes_permit_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Да, больше 18 месяцев"),
                         callback_data="DEU_med_over_eighteen_months_rus"),
    InlineKeyboardButton(text=(
        "Нет, менее 18 месяцев"),
                         callback_data="DEU_med_duldung_question_rus"),
    )
DEU_med_yes_permit_rus_buttons = DEU_med_yes_permit_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_yes_permit_rus")
async def DEU_med_yes_permit_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_yes_permit_rus_buttons,
        parse_mode="html",
        text="Вы находитесь в Германии больше 18 месяцев?"
    )


# - Язык украинский -
# Клавиатура:
DEU_med_yes_permit_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_yes_permit_ukr_buttons = DEU_med_yes_permit_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Так, більше 18 місяців"),
                         callback_data="DEU_med_over_eighteen_months_ukr"),
    InlineKeyboardButton(text=(
        "Ні, менше 18 місяців"),
                         callback_data="DEU_med_duldung_question_ukr"),
    )
DEU_med_yes_permit_ukr_buttons = DEU_med_yes_permit_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_yes_permit_ukr")
async def DEU_med_yes_permit_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_yes_permit_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВы находитесь в Германии больше 18 месяцев?")
    )
...
# - Язык русский -
# Клавиатура:
DEU_med_no_permit_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_no_permit_rus_buttons = DEU_med_no_permit_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_no_permit_rus")
async def DEU_med_no_permit_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_no_permit_rus_buttons,
        parse_mode="html",
        text=("Пожалуйста, обратитесь за разрешением на пребывание"
              " (Aufenthaltserlaubnis) в ведомства вашего города п"
              "ребывания:\nhttps://bamf-navi.bamf.de/de/Themen/Beh"
              "oerden/")
    )
...
# - Язык украинский -
# Клавиатура:
DEU_med_no_permit_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_no_permit_ukr_buttons = DEU_med_no_permit_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_no_permit_ukr")
async def DEU_med_no_permit_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_no_permit_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nПожалуйста, обратитесь за разрешением на пре"
              "бывание (Aufenthaltserlaubnis) в ведомства вашего г"
              "орода пребывания:\nhttps://bamf-navi.bamf.de/de/The"
              "men/Behoerden/")
    )


# --- Кнопка МЕДИЦИНА : "Да, больше 18 месяцев" ---
# - Язык русский -
# Клавиатура:
DEU_med_over_eighteen_months_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_over_eighteen_months_rus_buttons = DEU_med_over_eighteen_months_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Где записаться к врачу"),
                         callback_data="DEU_med_doctor_appointment_rus"),
    )
DEU_med_over_eighteen_months_rus_buttons = DEU_med_over_eighteen_months_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_over_eighteen_months_rus")
async def DEU_med_over_eighteen_months_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_over_eighteen_months_rus_buttons,
        parse_mode="html",
        text=("Посмотреть, где возможность получить медицинскую по"
              "мощь в разных землях Германии и записаться к врачу:"
              "")
    )
...
# - Язык украинский -
# Клавиатура:
DEU_med_over_eighteen_months_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_over_eighteen_months_ukr_buttons = DEU_med_over_eighteen_months_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Де записатися до лікаря"),
                         callback_data="DEU_med_doctor_appointment_ukr"),
    )
DEU_med_over_eighteen_months_ukr_buttons = DEU_med_over_eighteen_months_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_over_eighteen_months_ukr")
async def DEU_med_over_eighteen_months_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_over_eighteen_months_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nПосмотреть, где возможность получить медицин"
              "скую помощь в разных землях Германии и записаться к"
              " врачу:")
    )


# --- Кнопка МЕДИЦИНА : "Нет, менее 18 месяцев" ---
# - Язык русский -
# Клавиатура:
DEU_med_duldung_question_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_duldung_question_rus_buttons = DEU_med_duldung_question_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Нет карты Duldung"),
                         callback_data="DEU_med_krankenschein_rus"),
    InlineKeyboardButton(text=(
        "Да, есть карта Duldung"),
                         callback_data="DEU_med_yes_duldung_rus"),
    )
DEU_med_duldung_question_rus_buttons = DEU_med_duldung_question_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_duldung_question_rus")
async def DEU_med_duldung_question_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_duldung_question_rus_buttons,
        parse_mode="html",
        text="У вас есть специальная карта Duldung?"
    )


# - Язык украинский -
# Клавиатура:
DEU_med_duldung_question_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_duldung_question_ukr_buttons = DEU_med_duldung_question_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Немає карти Duldung"),
                         callback_data="DEU_med_krankenschein_ukr"),
    InlineKeyboardButton(text=(
        "Так, є карта Duldung"),
                         callback_data="DEU_med_yes_duldung_ukr"),
    )
DEU_med_duldung_question_ukr_buttons = DEU_med_duldung_question_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_duldung_question_ukr")
async def DEU_med_duldung_question_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_duldung_question_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nУ вас есть специальная карта Duldung?")
    )


# --- Кнопка МЕДИЦИНА : "Нет карты Duldung" ---
# - Язык русский -
# Клавиатура:
DEU_med_krankenschein_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_krankenschein_rus_buttons = DEU_med_krankenschein_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Где записаться к врачу"),
                         callback_data="DEU_med_doctor_appointment_rus"),
    )
DEU_med_krankenschein_rus_buttons = DEU_med_krankenschein_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_krankenschein_rus")
async def DEU_med_krankenschein_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_krankenschein_rus_buttons,
        parse_mode="html",
        text=("Запросите в социальной службе специальный больничны"
              "й лист (Krankenschein).\nПосле его получения узнайт"
              "е о возможности получить медицинскую помощь в разны"
              "х землях Германии и запишитесь к врачу:")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_krankenschein_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_krankenschein_ukr_buttons = DEU_med_krankenschein_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Де записатися до лікаря"),
                         callback_data="DEU_med_doctor_appointment_ukr"),
    )
DEU_med_krankenschein_ukr_buttons = DEU_med_krankenschein_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_krankenschein_ukr")
async def DEU_med_krankenschein_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_krankenschein_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nЗапросите в социальной службе специальный бо"
              "льничный лист (Krankenschein).\nПосле его получения"
              " узнайте о возможности получить медицинскую помощь "
              "в разных землях Германии и запишитесь к врачу:")
    )


# --- Кнопка МЕДИЦИНА : "Где записаться к врачу" ---
# - Язык русский -
# Клавиатура:
DEU_med_doctor_appointment_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_doctor_appointment_rus_buttons = DEU_med_doctor_appointment_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_doctor_appointment_rus")
async def DEU_med_doctor_appointment_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_doctor_appointment_rus_buttons,
        parse_mode="html",
        text=("Возможность получить медицинскую помощь в разных зе"
              "млях Германии:\nhttp://www.gesundheit-ein-menschenr"
              "echt.de/kontaktstellen\n\nВы можете записаться на п"
              "рием к врачу через сайты:\nhttps://www.bundesaerzte"
              "kammer.de/service/arztsuche/\n \nhttps://jameda.de/"
              "ukraine/\n\nhttps://www.doctolib.de/\n(можно посмот"
              "реть на каком языке говорит врач).\n\nhttps://www.j"
              "ameda.de/berlin/aerzte/gruppe/\n(поиск врача, можно"
              " смотреть на каком языке говорит врач)\n\nМедицинск"
              "ие предложения от европейской волонтерской сети (на"
              " английском):\nhttps://helppeopleleaveukraine.org/p"
              "osting-category/medicine")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_doctor_appointment_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_doctor_appointment_ukr_buttons = DEU_med_doctor_appointment_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_doctor_appointment_ukr")
async def DEU_med_doctor_appointment_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_doctor_appointment_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВозможность получить медицинскую помощь в ра"
              "зных землях Германии:\nhttp://www.gesundheit-ein-me"
              "nschenrecht.de/kontaktstellen\n\nВы можете записать"
              "ся на прием к врачу через сайты:\nhttps://www.bunde"
              "saerztekammer.de/service/arztsuche/\n \nhttps://jam"
              "eda.de/ukraine/\n\nhttps://www.doctolib.de/\n(можно"
              " посмотреть на каком языке говорит врач).\n\nhttps:"
              "//www.jameda.de/berlin/aerzte/gruppe/\n(поиск врача"
              ", можно смотреть на каком языке говорит врач)\n\nМе"
              "дицинские предложения от европейской волонтерской с"
              "ети (на английском):\nhttps://helppeopleleaveukrain"
              "e.org/posting-category/medicine")
    )


# --- Кнопка МЕДИЦИНА : "Да, есть карта Duldung" ---
# - Язык русский -
# Клавиатура:
DEU_med_yes_duldung_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_yes_duldung_rus_buttons = DEU_med_yes_duldung_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Где записаться к врачу"),
                         callback_data="DEU_med_doctor_appointment_rus"),
    )
DEU_med_yes_duldung_rus_buttons = DEU_med_yes_duldung_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_yes_duldung_rus")
async def DEU_med_yes_duldung_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_yes_duldung_rus_buttons,
        parse_mode="html",
        text=("Посмотреть, где возможность получить медицинскую по"
              "мощь в разных землях Германии и записаться к врачу:"
              "")
...
# - Язык украинский -
# Клавиатура:
DEU_med_yes_duldung_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_yes_duldung_ukr_buttons = DEU_med_yes_duldung_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Де записатися до лікаря"),
                         callback_data="DEU_med_doctor_appointment_ukr"),
    )
DEU_med_yes_duldung_ukr_buttons = DEU_med_yes_duldung_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_yes_duldung_ukr")
async def DEU_med_yes_duldung_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_yes_duldung_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nПосмотреть, где возможность получить медицин"
              "скую помощь в разных землях Германии и записаться к"
...
# --- Кнопка МЕДИЦИНА : "Удаленная консультация врача" ---
# - Язык русский -
# Клавиатура:
DEU_med_remote_doctor_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_remote_doctor_rus_buttons = DEU_med_remote_doctor_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_remote_doctor_rus")
async def DEU_med_remote_doctor_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_remote_doctor_rus_buttons,
        parse_mode="html",
        text=("Вы можете воспользоваться удаленной консультацией в"
              "рача:\nhttps://doctors4ua.com\n\nhttps://viveohealt"
              "h.com/free-online-doctor-consultation-for-ukraine\n"
              "\nhttps://docs.google.com/spreadsheets/d/1hmuBUETnC"
              "CbkDn_ELdsd4Skzw30wLLVZE0fr_A3Fh24/edit#gid=0\n(Вкл"
              "ючая удаленную помощь при родах)\n\nhttps://www.tah"
              "icare.com/ukraine\n\nМедицинские предложения от евр"
              "опейской волонтерской сети (на английском):\nhttps:"
              "//helppeopleleaveukraine.org/posting-category/medic"
              "ine")
    )
...
# - Язык украинский -
# Клавиатура:
DEU_med_remote_doctor_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_remote_doctor_ukr_buttons = DEU_med_remote_doctor_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_remote_doctor_ukr")
async def DEU_med_remote_doctor_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_remote_doctor_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВы можете воспользоваться удаленной консульт"
              "ацией врача:\nhttps://doctors4ua.com\n\nhttps://viv"
              "eohealth.com/free-online-doctor-consultation-for-uk"
              "raine\n\nhttps://docs.google.com/spreadsheets/d/1hm"
              "uBUETnCCbkDn_ELdsd4Skzw30wLLVZE0fr_A3Fh24/edit#gid="
              "0\n(Включая удаленную помощь при родах)\n\nhttps://"
              "www.tahicare.com/ukraine\n\nМедицинские предложения"
              " от европейской волонтерской сети (на английском):\\"
              "nhttps://helppeopleleaveukraine.org/posting-categor"
              "y/medicine")
    )


# --- Кнопка МЕДИЦИНА : "Получить помощь анонимно, без документов" ---
# - Язык русский -
# Клавиатура:
DEU_med_anonymous_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_anonymous_rus_buttons = DEU_med_anonymous_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_anonymous_rus")
async def DEU_med_anonymous_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_anonymous_rus_buttons,
        parse_mode="html",
        text=("Вы можете найти помощь на сайтах:\n\nhttp://www.ges"
              "undheit-ein-menschenrecht.de/kontaktstellen\n\nhttp"
              "s://www.malteser.de/menschen-ohne-krankenversicheru"
...
# - Язык украинский -
# Клавиатура:
DEU_med_anonymous_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_anonymous_ukr_buttons = DEU_med_anonymous_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_anonymous_ukr")
async def DEU_med_anonymous_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_anonymous_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВы можете найти помощь на сайтах:\n\nhttp://"
              "www.gesundheit-ein-menschenrecht.de/kontaktstellen\\"
              "n\nhttps://www.malteser.de/menschen-ohne-krankenver"
              "sicherung.html#c700739\n\nhttps://medibueros.org/")
    )


# --- Кнопка МЕДИЦИНА : "Беременность" ---
# - Язык русский -
# Клавиатура:
DEU_med_pregnancy_question_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_pregnancy_question_rus_buttons = DEU_med_pregnancy_question_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Да, и хочу сохранить беременность"),
                         callback_data="DEU_med_pregnancy_keep_rus"),
    InlineKeyboardButton(text=(
        "Да, и хочу сделать аборт"),
                         callback_data="DEU_med_abortion_rus"),
    )
DEU_med_pregnancy_question_rus_buttons = DEU_med_pregnancy_question_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_pregnancy_question_rus")
async def DEU_med_pregnancy_question_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_pregnancy_question_rus_buttons,
        parse_mode="html",
        text="Вы беременны?"
    )
...
# - Язык украинский -
# Клавиатура:
DEU_med_pregnancy_question_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_pregnancy_question_ukr_buttons = DEU_med_pregnancy_question_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Так, і хочу зберегти вагітність"),
                         callback_data="DEU_med_pregnancy_keep_ukr"),
    InlineKeyboardButton(text=(
        "Так, і хочу зробити аборт"),
                         callback_data="DEU_med_abortion_ukr"),
    )
DEU_med_pregnancy_question_ukr_buttons = DEU_med_pregnancy_question_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_pregnancy_question_ukr")
async def DEU_med_pregnancy_question_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_pregnancy_question_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВы беременны?")
    )
...
# --- Кнопка МЕДИЦИНА : "Да, и хочу сохранить беременность" ---
# - Язык русский -
# Клавиатура:
DEU_med_pregnancy_keep_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_pregnancy_keep_rus_buttons = DEU_med_pregnancy_keep_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_pregnancy_keep_rus")
async def DEU_med_pregnancy_keep_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_pregnancy_keep_rus_buttons,
        parse_mode="html",
        text=("Подробную информацию вы можете получить на сайте:\n"
              "https://handbookgermany.de/ru/live/pregnancy.html")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_pregnancy_keep_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_pregnancy_keep_ukr_buttons = DEU_med_pregnancy_keep_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_pregnancy_keep_ukr")
async def DEU_med_pregnancy_keep_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_pregnancy_keep_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nПодробную информацию вы можете получить на с"
              "айте:\nhttps://handbookgermany.de/ru/live/pregnancy"
              ".html")
    )


# --- Кнопка МЕДИЦИНА : "Да, и хочу сделать аборт" ---
# - Язык русский -
# Клавиатура:
DEU_med_abortion_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_abortion_rus_buttons = DEU_med_abortion_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_abortion_rus")
async def DEU_med_abortion_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_abortion_rus_buttons,
        parse_mode="html",
        text=("Обратитесь в службу Schwangerschaftskonfliktberatun"
              "g.\nКоординаты вы можете найти на сайтах:\nhttps://"
              "www.profamilia.de//themen/schwangerschaftsabbruch\n"
              "\nhttps://www.caritas.de/glossare/schwangerschaftsk"
              "onfliktberatung\n\nПосле консультации (переводчик б"
              "удет представлен вам службой бесплатно), Вы получит"
              "е направление на аборт.\n\n\nПодробную информацию в"
              "ы также можете получить на сайте:\nhttps://handbook"
              "germany.de/ru/live/pregnancy.html")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_abortion_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_abortion_ukr_buttons = DEU_med_abortion_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_abortion_ukr")
async def DEU_med_abortion_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_abortion_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nОбратитесь в службу Schwangerschaftskonflikt"
              "beratung.\nКоординаты вы можете найти на сайтах:\nh"
              "ttps://www.profamilia.de//themen/schwangerschaftsab"
              "bruch\n\nhttps://www.caritas.de/glossare/schwangers"
              "chaftskonfliktberatung\n\nПосле консультации (перев"
              "одчик будет представлен вам службой бесплатно), Вы "
              "получите направление на аборт.\n\n\nПодробную инфор"
              "мацию вы также можете получить на сайте:\nhttps://h"
              "andbookgermany.de/ru/live/pregnancy.html")
    )


# --- Кнопка МЕДИЦИНА : "Какие лекарства оплатит страховка" ---
# - Язык русский -
# Клавиатура:
DEU_med_insuarance_medicines_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_insuarance_medicines_rus_buttons = DEU_med_insuarance_medicines_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_insuarance_medicines_rus")
async def DEU_med_insuarance_medicines_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_insuarance_medicines_rus_buttons,
        parse_mode="html",
        text=("Информацию Вы можете получить на странице:\nhttps:/"
              "/www.tupa-germania.ru/meditsina/rezept-medikament.h"
              "tml")
    )
...
# - Язык украинский -
# Клавиатура:
DEU_med_insuarance_medicines_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_insuarance_medicines_ukr_buttons = DEU_med_insuarance_medicines_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_insuarance_medicines_ukr")
async def DEU_med_insuarance_medicines_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_insuarance_medicines_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nИнформацию Вы можете получить на странице:\n"
              "https://www.tupa-germania.ru/meditsina/rezept-medik"
              "ament.html")
    )


# --- Кнопка МЕДИЦИНА : "Проблемы с кассой больничного страхования" ---
# - Язык русский -
# Клавиатура:
DEU_med_insuarance_issues_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_insuarance_issues_rus_buttons = DEU_med_insuarance_issues_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_insuarance_issues_rus")
async def DEU_med_insuarance_issues_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_insuarance_issues_rus_buttons,
        parse_mode="html",
        text=("Если у вас возникли проблемы с кассой больничного с"
              "трахования (например, она отклонило ваше заявление "
              "на регистрацию или отказывается оплачивать посещени"
              "е врача или лекарство), то вы можете обратиться за "
              "помощью в службу Unabhängige Patientenberatung. По "
              "номеру телефона 0800-0117724 можно получить консуль"
              "тацию на русском языке. Звонок и советы бесплатны.\\"
              "n\nТакже работают Фармацевты без границ\nс горячей "
              "линией, которая помогает получить доступ\nк определ"
              "енным лекарствам\n\nhttps://www.apotheker-ohne-gren"
              "zen.de/kontakt/")
    )
...
# - Язык украинский -
# Клавиатура:
DEU_med_insuarance_issues_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_insuarance_issues_ukr_buttons = DEU_med_insuarance_issues_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_insuarance_issues_ukr")
async def DEU_med_insuarance_issues_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_insuarance_issues_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nЕсли у вас возникли проблемы с кассой больни"
              "чного страхования (например, она отклонило ваше зая"
              "вление на регистрацию или отказывается оплачивать п"
              "осещение врача или лекарство), то вы можете обратит"
              "ься за помощью в службу Unabhängige Patientenberatu"
              "ng. По номеру телефона 0800-0117724 можно получить "
              "консультацию на русском языке. Звонок и советы бесп"
              "латны.\n\nТакже работают Фармацевты без границ\nс г"
              "орячей линией, которая помогает получить доступ\nк "
              "определенным лекарствам\n\nhttps://www.apotheker-oh"
              "ne-grenzen.de/kontakt/")
    )


# --- Кнопка МЕДИЦИНА : "Помощь детям в спектре аутизма" ---
# - Язык русский -
# Клавиатура:
DEU_med_autism_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_autism_rus_buttons = DEU_med_autism_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_autism_rus")
async def DEU_med_autism_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_autism_rus_buttons,
        parse_mode="html",
        text=("Вы можете получить информацию на сайте:\nhttps://ww"
              "w.zak-hannover.de/kontakt/unbuerokratische-hilfen-f"
              "uer-gefluechtete-menschen")
    )


# - Язык украинский -
# Клавиатура:
DEU_med_autism_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_med_autism_ukr_buttons = DEU_med_autism_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_med_autism_ukr")
async def DEU_med_autism_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_med_autism_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВы можете получить информацию на сайте:\nhtt"
              "ps://www.zak-hannover.de/kontakt/unbuerokratische-h"
              "ilfen-fuer-gefluechtete-menschen")
    )
...
# - Язык русский -
# Клавиатура:
DEU_wrk_main_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_wrk_main_rus_buttons = DEU_wrk_main_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Трудовая дискриминация"),
                         callback_data="DEU_sec_labor_rus"),
    InlineKeyboardButton(text=(
        "Консультации по трудоустройству"),
                         callback_data="DEU_wrk_consult_rus"),
    InlineKeyboardButton(text=(
        "Информация о социальных выплатах"),
                         callback_data="DEU_law_social_payments_rus"),
    )
DEU_wrk_main_rus_buttons = DEU_wrk_main_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_wrk_main_rus")
async def DEU_wrk_main_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_wrk_main_rus_buttons,
        parse_mode="html",
        text="Выберите, что Вас интересует:"
    )
...
# - Язык украинский -
# Клавиатура:
DEU_wrk_main_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_wrk_main_ukr_buttons = DEU_wrk_main_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Labor discrimination"),
                         callback_data="DEU_sec_labor_ukr"),
    InlineKeyboardButton(text=(
        "Консультації з працевлаштування"),
                         callback_data="DEU_wrk_consult_ukr"),
    InlineKeyboardButton(text=(
        "Інформація про соціальні виплати"),
                         callback_data="DEU_law_social_payments_ukr"),
    )
DEU_wrk_main_ukr_buttons = DEU_wrk_main_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_wrk_main_ukr")
async def DEU_wrk_main_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_wrk_main_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nВыберите, что Вас интересует:")
    )
...
# --- Кнопка РАБОТА : "Консультации по трудоустройству" ---
# - Язык русский -
# Клавиатура:
DEU_wrk_consult_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_wrk_consult_rus_buttons = DEU_wrk_consult_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_wrk_consult_rus")
async def DEU_wrk_consult_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_wrk_consult_rus_buttons,
        parse_mode="html",
        text=("На сайте агентства по трудоустройству:\nhttps://www"
              ".arbeitsagentur.de/ua/ua/ukraine\nможно найти адрес"
              " местного филиала, специалисты которого предоставят"
              " подробную консультацию, помогут найти работу бежен"
              "цам в Германии, подобрать языковые или профессионал"
              "ьные курсы.\n\nКонсультацию о том, где искать работ"
              "у в Германии, также можно получить по телефону горя"
              "чей линии:\n0911 178-7915\n(сотрудники говорят на у"
              "краинском и русском языках).")
    )


# - Язык украинский -
# Клавиатура:
DEU_wrk_consult_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_wrk_consult_ukr_buttons = DEU_wrk_consult_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_wrk_consult_ukr")
async def DEU_wrk_consult_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_wrk_consult_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nНа сайте агентства по трудоустройству:\nhttp"
              "s://www.arbeitsagentur.de/ua/ua/ukraine\nможно найт"
              "и адрес местного филиала, специалисты которого пред"
              "оставят подробную консультацию, помогут найти работ"
              "у беженцам в Германии, подобрать языковые или профе"
              "ссиональные курсы.\n\nКонсультацию о том, где искат"
              "ь работу в Германии, также можно получить по телефо"
              "ну горячей линии:\n0911 178-7915\n(сотрудники говор"
              "ят на украинском и русском языках).")
    )
...
DEU_law_main_rus_buttons = DEU_law_main_rus_buttons.add(
    InlineKeyboardButton(text=(
        "Информация о социальных выплатах"),
                         callback_data="DEU_law_social_payments_rus"),
    )
...
DEU_law_main_ukr_buttons = DEU_law_main_ukr_buttons.add(
    InlineKeyboardButton(text=(
        "Інформація про соціальні виплати"),
                         callback_data="DEU_law_social_payments_ukr"),
    )
...
# --- Кнопка ЮРИДИЧЕСКАЯ ПОМОЩЬ : "Информация о социальных выплатах" ---
# - Язык русский -
# Клавиатура:
DEU_law_social_payments_rus_buttons = InlineKeyboardMarkup(row_width=1)
DEU_law_social_payments_rus_buttons = DEU_law_social_payments_rus_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_rus"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-RUS"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_law_social_payments_rus")
async def DEU_law_social_payments_rus(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_law_social_payments_rus_buttons,
        parse_mode="html",
        text=("Официальное разъяснение Службы по делам беженцев:\n"
              "https://www.bmas.de/DE/Europa-und-die-Welt/Europa/U"
              "kraine/FAQ-RU/faq-art-ru.html")
    )


# - Язык украинский -
# Клавиатура:
DEU_law_social_payments_ukr_buttons = InlineKeyboardMarkup(row_width=1)
DEU_law_social_payments_ukr_buttons = DEU_law_social_payments_ukr_buttons.row(
    InlineKeyboardButton(text=(
        "🗂 К разделам"), callback_data="DEU_ukr"),
    InlineKeyboardButton(text=(
        "🌍 Страны"), callback_data="get-UKR"),
...
# Сообщение бота:
@dp.callback_query_handler(lambda c: c.data == "DEU_law_social_payments_ukr")
async def DEU_law_social_payments_ukr(message: Message):
    await bot.send_message(
        chat_id=message.from_user.id,
        reply_markup=DEU_law_social_payments_ukr_buttons,
        parse_mode="html",
        text=("<i>(Вибачте, ця інформація єтільки російською мовою"
              ")</i>\nОфициальное разъяснение Службы по делам беже"
              "нцев:\nhttps://www.bmas.de/DE/Europa-und-die-Welt/E"
              "uropa/Ukraine/FAQ-RU/faq-art-ru.html")
    )
